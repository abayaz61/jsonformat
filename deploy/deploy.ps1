...
# ═══════════════════════════════════════════════════════════
# ADIM 3: VERSIYON GUNCELLEME VE BUILD
# ═══════════════════════════════════════════════════════════
Write-Step "3-10" "Versiyon Guncelleniyor ve Build Aliniyor"

Write-SubStep "Patch versiyon artiriliyor..."
$NEW_VERSION = node "$PSScriptRoot/bump-version.mjs" "$SOURCE_DIR/package.json"
if ($LASTEXITCODE -ne 0) {
    Write-Failure "Versiyon guncellenemedi!"
    exit 1
}
Write-Success "Yeni versiyon: v$NEW_VERSION"
...
Write-Detail "Versiyon" "v$NEW_VERSION"
